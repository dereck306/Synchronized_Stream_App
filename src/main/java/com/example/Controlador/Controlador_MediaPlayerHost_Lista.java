...
public class Controlador_MediaPlayerHost_Lista implements Initializable {
    ...
    int posicion1 = Controlador_Siguiente.posicion;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        VideosListaDAO videosLista = new VideosListaDAO();
        ArrayList<VideoLista> Videos = videosLista.metodoBuscarVideosLista();

        Ruta = Videos.get(posicion1).getPath();

        mediaVideo = new Media(new File(Ruta).toURI().toString());
